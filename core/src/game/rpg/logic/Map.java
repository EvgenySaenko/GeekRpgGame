...
public class Map {
    private class Obstacle {
        ...
        public Obstacle() {
            ...
            if (this.index == 4 || this.index ==6){//над пеньком и камнем стрела пролетит
    ...
    public int getWidthLimit() {//какой размер карты по x
        return MAP_CELLS_WIDTH * CELL_WIDTH;
    }

    public int getHeightLimit() {//какой размер карты по y
        return MAP_CELLS_HEIGHT * CELL_HEIGHT;//количество ячеек по высоте умноженое на высоту ячейки
    }
